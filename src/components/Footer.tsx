...
export default function Footer() {
    ...
    return (
        ...
        <footer className="footer font-1 sm:footer-horizontal bg-base-300 p-10">
  <aside>
    {/* <svg
      width="50"
      height="50"
...
<footer className="footer footer-center bg-neutral text-neutral-content p-2">
    ...
    <p className="inline">Made with ❤️ as a <a href="https://plastuchino.xyz">Hernandez Production</a></p>
